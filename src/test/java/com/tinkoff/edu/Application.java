...
class Application {
    public static void main(String[] args) {
        ...
        Message message7 = new Message(SeverityLevel.MINOR, "");
        ...
        messageService.log(MessageOrder.ASC, message1, message2, message3, message4, message5);
        messageService.log(MessageOrder.DESC, message1, message2, message3, message4, message5);
        messageService.log(MessageOrder.ASC, Doubling.DOUBLES, message1, message2, message3, message4, message5);
        messageService.log(MessageOrder.DESC, Doubling.DISTINCT, message1, message2, message3, message4, message5);
        messageService.log(MessageOrder.ASC, Doubling.DISTINCT, message1, message2, message3, message4, message5);
        messageService.log(MessageOrder.DESC, Doubling.DOUBLES, message1, message2, message3, message4, message5);
        messageService.log(MessageOrder.ASC, Doubling.DOUBLES, message1, message2, message3, message4,message5, message6);
        messageService.log(MessageOrder.DESC, Doubling.DISTINCT, message1, message2, message3, message4, message5, message7);
